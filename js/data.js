...
// fields (youtubeId/youtubeSearch, tweetUrl/xSearch) and an optional `tags` array.
// Tags power the achievement filter; allowed values are
// "ballon-dor" | "world-cup" | "trophy" | "record". Omit or leave [] when none
// apply — such cards still appear under "All" and their era filter.
//
// NEVER fabricate a youtubeId / tweetUrl. Leave it "" and the UI falls back to a
// reliable search link built from the *Search field.
